...
#ifndef SRC_I2C_LCD_C_
#define SRC_I2C_LCD_C_
...
void lcd_command(uint8_t command)
{
	...
	high_nibble = command & 0xf0 ; //high 4bit gettodage
	low_nibble = (command << 4) & 0xf0 ; //low 4bit gettodage
...
void lcd_data(uint8_t data)
{
	uint8_t high_nibble, low_nibble;
	uint8_t  i2c_buffer[4] ;
	high_nibble = data & 0xf0 ; //high 4bit gettodage
	low_nibble = (data << 4) & 0xf0 ; //low 4bit gettodage
